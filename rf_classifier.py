...
def grid_search_parameter(train_x, train_y):
    ...
    param_test_estimators = {'n_estimators': list(range(10, 151, 10))}
    gsearch_estimators = GridSearchCV(estimator=RandomForestClassifier(min_samples_split=50,
                                                                       min_samples_leaf=15,
                                                                       max_depth=13,
                                                                       max_features=45,
    ...
    print(gsearch_estimators.grid_scores_)
    ...
    param_test_depth_minsplit = {'max_depth': list(range(13, 27, 2)), 'min_samples_split': list(range(7, 21, 2))}
    ...
    print(gsearch_depth_minsplit.grid_scores_)
    ...
    gsearch_minsplit_minleaf = GridSearchCV(estimator=RandomForestClassifier(n_estimators=130, max_depth=15,
                                                                             max_features=25,
                                                                             class_weight='balanced_subsample',
                                                                             random_state=10),
    ...
    print(gsearch_minsplit_minleaf.grid_scores_)
    ...
    print(gsearch_features.grid_scores_)
...
def main():
    ...
    test_result = 'J:/FF/application_dataset/chongqing_agir/att000-result.csv'
